<!DOCTYPE html>
@php
	$language=\App\Models\Language::where(\App\Models\Language::KEY_COLUMN_NAME,Session::get('lang'))->first();
@endphp
<html lang="{{$language->getKey()}}" @if($language->getRtl()) dir="rtl" @else dir="ltr" @endif>

<head>
	<base href="">
	@yield('head')
	<title>Brand | 	@yield('page_titel')</title>
	<meta charset="utf-8" />
					...
					<div class="hover-scroll-overlay-y my-5 my-lg-5" id="kt_aside_menu_wrapper" data-kt-scroll="true" data-kt-scroll-activate="{default: false, lg: true}" data-kt-scroll-height="auto" data-kt-scroll-dependencies="#kt_aside_logo, #kt_aside_footer" data-kt-scroll-wrappers="#kt_aside_menu" data-kt-scroll-offset="0">
						...
						<div class="menu menu-column menu-title-gray-800 menu-state-title-primary menu-state-icon-primary menu-state-bullet-primary menu-arrow-gray-500" id="#kt_aside_menu" data-kt-menu="true">
							...
							<div data-kt-menu-trigger="click" class="menu-item menu-accordion">
								...
								@canany(['Admin','view languages'])
								<div class="menu-item">
									<a class="menu-link @if( Route::currentRouteName() == 'languages.index') active @endif" href="{{route('languages.index')}}">
										<span class="menu-icon">
											<!--begin::Svg Icon | path: icons/duotune/general/gen025.svg-->
											<span class="svg-icon svg-icon-2">
												<svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none">
													<path d="M14.789 19.4199C14.679 19.4199 14.559 19.3899 14.459 19.3399C14.089 19.1499 13.939 18.6999 14.119 18.3299L16.259 14.0599C16.389 13.8099 16.649 13.6499 16.929 13.6499C17.209 13.6499 17.469 13.8099 17.599 14.0699L19.739 18.3399C19.929 18.7099 19.779 19.1599 19.399 19.3499C19.029 19.5399 18.579 19.3899 18.389 19.0099L16.929 16.0799L15.469 19.0099C15.329 19.2699 15.059 19.4199 14.789 19.4199Z" fill="#292D32"/>
													<path d="M18.6801 18.6602H15.1602C14.7502 18.6602 14.4102 18.3202 14.4102 17.9102C14.4102 17.5002 14.7502 17.1602 15.1602 17.1602H18.6801C19.0901 17.1602 19.4301 17.5002 19.4301 17.9102C19.4301 18.3202 19.1001 18.6602 18.6801 18.6602Z" fill="#292D32"/>
													<path d="M16.9198 22.7498C13.7098 22.7498 11.0898 20.1398 11.0898 16.9198C11.0898 13.6998 13.6998 11.0898 16.9198 11.0898C20.1298 11.0898 22.7498 13.6998 22.7498 16.9198C22.7498 20.1398 20.1398 22.7498 16.9198 22.7498ZM16.9198 12.5998C14.5298 12.5998 12.5898 14.5398 12.5898 16.9298C12.5898 19.3198 14.5298 21.2598 16.9198 21.2598C19.2998 21.2598 21.2498 19.3198 21.2498 16.9298C21.2498 14.5398 19.3098 12.5998 16.9198 12.5998Z" fill="#292D32"/>
													<path d="M4.86 12.7003C3.75 12.7003 2.87 12.3902 2.25 11.7902C1.59 11.1502 1.25 10.1802 1.25 8.93024V5.01025C1.25 2.58025 2.59 1.24023 5.02 1.24023H8.94C10.19 1.24023 11.15 1.57023 11.8 2.24023C12.43 2.89023 12.74 3.83027 12.71 5.03027V8.93024C12.74 10.1502 12.43 11.1103 11.78 11.7603C11.13 12.4103 10.17 12.7102 8.92999 12.6902H5.03C4.96 12.7002 4.91 12.7003 4.86 12.7003ZM5.02 2.75024C3.41 2.75024 2.75 3.41026 2.75 5.02026V8.94025C2.75 9.77025 2.92999 10.3702 3.28999 10.7202C3.63999 11.0602 4.20001 11.2103 4.99001 11.2003H8.92999C9.76999 11.2203 10.35 11.0503 10.7 10.7003C11.05 10.3503 11.21 9.76026 11.19 8.95026V5.01025C11.21 4.21025 11.05 3.64022 10.71 3.29022C10.36 2.93022 9.75999 2.75024 8.92999 2.75024H5.02V2.75024Z" fill="#292D32"/>
													<path d="M8.99945 6.59961H4.93945C4.52945 6.59961 4.18945 6.25961 4.18945 5.84961C4.18945 5.43961 4.52945 5.09961 4.93945 5.09961H8.99945C9.40945 5.09961 9.74945 5.43961 9.74945 5.84961C9.74945 6.25961 9.41945 6.59961 8.99945 6.59961Z" fill="#292D32"/>
													<path d="M6.98047 6.59991C6.57047 6.59991 6.23047 6.25991 6.23047 5.84991V5.16992C6.23047 4.75992 6.57047 4.41992 6.98047 4.41992C7.39047 4.41992 7.73047 4.75992 7.73047 5.16992V5.84991C7.73047 6.25991 7.39047 6.59991 6.98047 6.59991Z" fill="#292D32"/>
													<path d="M4.93945 9.75983C4.52945 9.75983 4.18945 9.41983 4.18945 9.00983C4.18945 8.59983 4.52945 8.25983 4.93945 8.25983C6.20945 8.25983 7.23946 7.17984 7.23946 5.83984C7.23946 5.42984 7.57946 5.08984 7.98946 5.08984C8.39946 5.08984 8.73946 5.42984 8.73946 5.83984C8.73946 7.99984 7.03945 9.75983 4.93945 9.75983Z" fill="#292D32"/>
													<path d="M9.01042 9.76007C8.08042 9.76007 7.19043 9.29008 6.56043 8.46008C6.31043 8.13008 6.38043 7.66003 6.71043 7.41003C7.04043 7.16003 7.51042 7.23005 7.76042 7.56005C8.10042 8.02005 8.55042 8.27008 9.01042 8.27008C9.42042 8.27008 9.76042 8.61008 9.76042 9.02008C9.76042 9.43008 9.42042 9.76007 9.01042 9.76007Z" fill="#292D32"/>
													...
													<path d="M22.0004 9.75C21.5904 9.75 21.2504 9.41 21.2504 9C21.2504 6.04 19.1904 3.55997 16.4204 2.90997L16.6904 3.35999C16.9004 3.71999 16.7904 4.18001 16.4304 4.39001C16.0804 4.60001 15.6104 4.49 15.4004 4.13L14.3504 2.38C14.2104 2.15 14.2104 1.86 14.3404 1.63C14.4704 1.39 14.7204 1.25 14.9904 1.25C19.2604 1.25 22.7404 4.73 22.7404 9C22.7504 9.41 22.4104 9.75 22.0004 9.75Z" fill="#292D32"/>
												</svg>
											</span>
											<!--end::Svg Icon-->
										</span>
										...
										<span class="menu-icon">
											...
											<span class="svg-icon svg-icon-2">
												<svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
													...
													<path d="M16 21H14C14 18.2386 11.7614 16 9 16C6.23858 16 4 18.2386 4 21H2C2 17.134 5.13401 14 9 14C12.866 14 16 17.134 16 21Z" fill="#2E3A59"/>
												</svg>
											</span>
											<!--end::Svg Icon-->
										</span>
								...
								@endcanany
								@canany(['Admin','view settings'])
								<div class="menu-item">
									<a class="menu-link @if( Route::currentRouteName() == 'settings.index') active @endif" href="{{route('settings.index')}}">
										<span class="menu-icon">
											<!--begin::Svg Icon | path: icons/duotune/general/gen025.svg-->
											<span class="svg-icon svg-icon-2">
												<svg width="22" height="22" viewBox="0 0 22 22" fill="none" xmlns="http://www.w3.org/2000/svg">
													<path d="M1.132 12.6298C0.952624 11.5505 0.952624 10.449 1.132 9.36977C2.234 9.39577 3.224 8.86777 3.609 7.93877C3.994 7.00877 3.667 5.93477 2.869 5.17577C3.50541 4.28505 4.28456 3.50557 5.175 2.86877C5.935 3.66677 7.009 3.99377 7.939 3.60877C8.869 3.22377 9.396 2.23277 9.369 1.13177C10.4489 0.952172 11.5511 0.952172 12.631 1.13177C12.604 2.23377 13.132 3.22377 14.061 3.60877C14.991 3.99377 16.065 3.66677 16.824 2.86877C17.7147 3.50518 18.4942 4.28433 19.131 5.17477C18.333 5.93477 18.006 7.00877 18.391 7.93877C18.776 8.86877 19.767 9.39577 20.868 9.36877C21.0476 10.4487 21.0476 11.5508 20.868 12.6308C19.766 12.6038 18.776 13.1318 18.391 14.0608C18.006 14.9908 18.333 16.0648 19.131 16.8238C18.4946 17.7145 17.7154 18.494 16.825 19.1308C16.065 18.3328 14.991 18.0058 14.061 18.3908C13.131 18.7758 12.604 19.7668 12.631 20.8678C11.5511 21.0474 10.4489 21.0474 9.369 20.8678C9.396 19.7658 8.868 18.7758 7.939 18.3908C7.009 18.0058 5.935 18.3328 5.176 19.1308C4.28529 18.4944 3.5058 17.7152 2.869 16.8248C3.667 16.0648 3.994 14.9908 3.609 14.0608C3.224 13.1308 2.233 12.6038 1.132 12.6308V12.6298ZM11 13.9998C11.7956 13.9998 12.5587 13.6837 13.1213 13.1211C13.6839 12.5585 14 11.7954 14 10.9998C14 10.2041 13.6839 9.44106 13.1213 8.87845C12.5587 8.31584 11.7956 7.99977 11 7.99977C10.2043 7.99977 9.44129 8.31584 8.87868 8.87845C8.31607 9.44106 8 10.2041 8 10.9998C8 11.7954 8.31607 12.5585 8.87868 13.1211C9.44129 13.6837 10.2043 13.9998 11 13.9998V13.9998Z" fill="#05527E"/>
												</svg>
											</span>
											<!--end::Svg Icon-->
										</span>
...
-->
									...
									<!--end::Quick links-->
									<!--begin::User-->
									@include('backend.components.user_dropdown')
									<!--end::User -->
	...
	<!-- sweetalerts (toastr) -->
	@include('backend.components.sweetalerts')
	@yield('script')
	<!--end::Javascript-->
</body>
<!--end::Body-->
